...
full4 <- full_join(full3,licor,by=join_by(Plant_ID,Sp_Code))

full5 <- full_join(full4,lma,by=join_by(Plant_ID,Sp_Code))
...
full <- full_join(full9,seed_a,by=join_by(Sp_Code))
...
# Duplicates of E2.PHATAN in ht -- investigate
# Duplicates of I3.EROCIC in CN
