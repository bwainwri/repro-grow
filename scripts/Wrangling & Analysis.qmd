...
```{r}
lf_area <- read_csv(here::here("data/LMA_lfarea_all.csv"))
...
summary(LMA)
list <- LMA[which(is.na(LMA$Dry_leaf_mass_g)),"Plant_ID"]
# 24 don't have masses
# interpolate LMA based on spp x population averages

# Check for duplicates
# C6 AMSMEN 2 is listed twice
LMA[which(duplicated(LMA$sample)),]

# A mess, start from scratch with run.ij





## Check for gaps and discrepancies -- maybe by species
```
